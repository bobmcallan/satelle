...
them from the database). So a parent cannot close while a child is still open;
the operator finishes or cancels the children first. See
[[satelle-done-is-last]] and [[satelle-agent-model]].
