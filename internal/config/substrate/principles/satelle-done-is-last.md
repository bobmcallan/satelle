...
tags: [type:principle]
applies_to: ["*"]
description: When placing a state or a gate on a workflow: done is ALWAYS terminal, and every quality gate sits BEFORE it. Reaching done means every gate on the path has already passed.
---
