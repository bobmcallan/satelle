...
tags: [type:principle]
applies_to: ["*"]
description: The agent model, for any question about a workflow step or role. A graph of steps, each run by a role with a bounded grant: the executor works, the reviewer judges read-only.
---
