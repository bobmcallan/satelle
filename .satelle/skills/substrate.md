...
type: skill
tags: [type:skill]
description: In-loop executor skill for satelle-substrate-workflow's in_progress step. Author the markdown-only slice under .satelle/ and/or docs/, reindex/validate, commit and push while engaged — no version bump, no release. Close is gated by satelle-substrate-only-check.
---
...
See [[satelle-agent-model]], the substrate workflow prose, and [[satelle-repo-agnostic]].
