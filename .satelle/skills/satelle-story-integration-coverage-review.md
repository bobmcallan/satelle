...
description: Plan→in_progress multi-reviewer axis (sty_4f0a15db). Isolated read-only judge — does the plan name tests (unit and/or integration) that would prove each AC? Parallel companion to satelle-story-plan-review.
---
