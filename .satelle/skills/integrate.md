...
Output run evidence: what you ran, what passed, what you repaired, anything still failing. `integration → release` is gated by `satelle-story-integration-review` plus the coded `make integration` check — they decide whether the slice proceeds.
