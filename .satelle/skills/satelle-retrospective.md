...
type: skill
tags: [type:skill]
description: Executor skill for the dispatched `retrospect` step (sty_b53730e2): an isolated agent reads a FINISHED story (ACs, plan, step summaries, verdicts, shipped diff) and files 1–3 improvement PROPOSALS as backlog stories — rubric gaps, CI/test gaps, process fixes, DRY debt. Proposes only; never edits code or reopens the reviewed story.
---
