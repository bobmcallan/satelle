...
description: Plan→in_progress multi-reviewer axis (sty_4f0a15db). Isolated read-only judge — does the plan respect mechanism-vs-substrate and avoid putting decisions in Go that belong in config? Parallel companion to satelle-story-plan-review.
---
