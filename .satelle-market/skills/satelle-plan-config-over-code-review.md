...
scope: project
type: skill
tags: [solo-dev, reviewer, gate, architecture]
description: Reviewer gate: plan prefers configuration over hard-coded product decisions. Isolated read-only companion on plan → in_progress.
---
