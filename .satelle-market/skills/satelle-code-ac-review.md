...
scope: project
type: skill
tags: [solo-dev, reviewer, gate, code-ac]
description: Reviewer gate for in_progress → integration: acceptance criteria met and unit plus integration tests exist for changed behaviour. Isolated read-only judge.
---
