...
scope: project
type: skill
tags: [solo-dev, reviewer, gate, deploy]
description: Reviewer gate for deploy evidence when a workflow includes a deploy step. Isolated read-only judge of recorded deploy outcomes.
---
